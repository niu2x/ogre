...
// class HYUE_API PixelBox : public Box, public ImageAlloc {
// public:
...
//     */
//     bool isConsecutive() const { return rowPitch == getWidth() && slicePitch == getWidth() * getHeight(); }
...
//     */
//     static void
//     packColour(const uint8 r, const uint8 g, const uint8 b, const uint8 a, const PixelFormat pf, void* dest);
//     /// @overload
//     static void
