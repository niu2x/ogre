...
// ZipArchive::ZipArchive(const String& name, const String& arch_type, const uint8_t* extern_buf, size_t extern_buf_sz)
//     : Archive(name, arch_type), zip_file_(nullptr)
// {
//     if(extern_buf)
//         buffer_ = std::make_shared<MemoryDataStream>(const_cast<uint8_t*>(extern_buf), extern_buf_sz);
// }
// //-----------------------------------------------------------------------
...
//     {
//         if(!buffer_)
//             buffer_ = std::make_shared<MemoryDataStream>(open_file_stream(name_, std::ios::binary));
